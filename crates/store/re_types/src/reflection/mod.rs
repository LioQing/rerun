...
fn generate_component_reflection() -> Result<ComponentReflectionMap, SerializationError> {
    ...
    let array = [
        ...
        (
            <SphericalHarmonics as Component>::name(),
            ComponentReflection {
                docstring_md: "A spherical harmonics up to degree 3.",
                deprecation_summary: None,
                custom_placeholder: Some(SphericalHarmonics::default().to_arrow()?),
                datatype: SphericalHarmonics::arrow_datatype(),
                verify_arrow_array: SphericalHarmonics::verify_arrow_array,
            },
        ),
        (
...
fn generate_archetype_reflection() -> ArchetypeReflectionMap {
    ...
    let array = [
        ...
        (
            ArchetypeName::new("rerun.archetypes.Gaussians3D"),
            ArchetypeReflection {
                display_name: "Gaussians 3D",
                deprecation_summary: None,
                scope: None,
                view_types: &["Spatial3DView", "Spatial2DView"],
                fields: vec![
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Scales",
                        component_type: "rerun.components.HalfSize3D".into(),
                        docstring_md: "The scales (standard deviation) along the three axes.",
                        is_required: true,
                    },
                    ArchetypeFieldReflection {
                        name: "poss",
                        display_name: "Poss",
                        component_type: "rerun.components.PoseTranslation3D".into(),
                        docstring_md: "The center position (mean) of the Gaussians.",
                        is_required: true,
                    },
                    ArchetypeFieldReflection {
                        name: "rots",
                        display_name: "Rots",
                        component_type: "rerun.components.PoseRotationQuat".into(),
                        docstring_md: "The rotation for the Gaussians via quaternion.",
                        is_required: true,
                    },
                    ArchetypeFieldReflection {
                        name: "colors",
                        display_name: "Colors",
                        component_type: "rerun.components.Color".into(),
                        docstring_md: "The colors for the Gaussians.",
                        is_required: true,
                    },
                    ArchetypeFieldReflection {
                        name: "sh",
                        display_name: "Sh",
                        component_type: "rerun.components.SphericalHarmonics".into(),
                        docstring_md: "Optional spherical harmonics of the Gaussians, up to degree 3.",
                        is_required: false,
                    },
                    ArchetypeFieldReflection {
                        name: "labels",
                        display_name: "Labels",
                        component_type: "rerun.components.Text".into(),
                        docstring_md: "Optional text labels for the Gaussians.",
                        is_required: false,
                    },
                    ArchetypeFieldReflection {
                        name: "show_labels",
                    ...
                    ArchetypeFieldReflection {
                        ...
                        display_name: "Class ids",
                        component_type: "rerun.components.ClassId".into(),
                        docstring_md: "Optional class ID for the Gaussians.\n\nThe class ID provides colors and labels if not specified explicitly.",
                        is_required: false,
                    },
                ],
            },
